...
const deleteTheCourse = async (courseId: string) => {
    ...
    return (    
        <div>
            <div className="flex items-center justify-between">
                ...
                <NavLink to="/courses/new" className="rounded-lg bg-sky-600 px-4 py-2 text-white font-medium hover:bg-sky-700 transition">
                Add Course
                </NavLink>
            </div>
            <Table columns={courseColumns} data={courses} renderActions={renderActions}/>
        </div>
    );
}